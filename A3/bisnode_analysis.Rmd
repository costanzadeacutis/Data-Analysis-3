...
The aim of this analysis is to find fast-growing firms for investment decisions. The fixed cost of investing in firms is 5000 euros. If the firm is fast-growing, the return is 1000 euros. Thus, if the firm is predicted to be fast-growing but it actually is not, investing in it would mean loosing 5000
FN = predict no fast growth and instead fast growing -> 1000
FP = predict fast growth but instead non-fast-growing -> 5000
