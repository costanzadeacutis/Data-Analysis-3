...
#target
#fast growth in one year
data <- data %>%
  group_by(comp_id) %>%
  mutate(fast_growth = ifelse(lead(growth_labor,1) > growth_labor_80th, 1, 0))
...
### Factor target
I create a factor for the target variable fast_growth: there are 11229 non-fast-growing firms and 3694 fast-growing
